...
# def add_predictions_to_kg(input_edges, predictions, output_file = './kg_edges_with_predictions.csv'):
input_edges = pd.read_csv('./input/merged_edge_list.tsv', sep="\t")
pred_df = pd.read_csv('1_predictions.csv')

add_predictions_to_kg(input_edges,pred_df)