...
class caseolapLIFT_knowledge_graph:
    def __init__(self, include_STRING: bool, include_REACTOME: bool):
        ...
        mesh_tree_file = ROOT + "/data/mtrees2021.bin"
        categories_file = ROOT + "/caseolap/input/categories.txt"

        #TODO: find these
        mesh_tree_to_mesh_id_file = ROOT + "/DYLAN-Projects/Drug Repurposing Knowledge Graph/output/disease2disease/edges_meshtree-IS-meshid.csv"
        edges_meshtree2meshtree_hierarchy = ROOT + "/DYLAN-Projects/Drug Repurposing Knowledge Graph/output/disease2disease/edges_meshtree2meshtree_hierarchy.csv"

        #caseolap
        caseolap_csv = ROOT + "/caseolap/result/caseolap.csv"
    ...
    @staticmethod
    def knowledge_graph():
        return Graph.from_csv(node_path = "graph_data/merged_node_list.tsv", \
                              node_list_separator = "\t", \
                              node_list_header = True, \
                              nodes_column = "node", \
                              node_list_node_types_column = "node_type", \
                              edge_path = "graph_data/merged_edge_list.tsv", \
                              edge_list_separator = "\t", \
